...
export function StudentManagementPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Year Filter Buttons and Search / Sort Bar */}
      <div className="flex flex-col lg:flex-row gap-3 lg:items-center justify-between">
        <div className="flex flex-wrap items-center gap-1.5 bg-slate-100 p-1.5 rounded-xl border border-slate-200/80 shrink-0">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full lg:w-auto">
          ...
          <Select
            ...
            options={[
              { value: "year_asc", label: "Sort: Year (1 → 4)" },
              { value: "year_desc", label: "Sort: Year (4 → 1)" },
